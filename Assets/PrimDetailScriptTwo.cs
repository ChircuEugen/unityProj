...
public class PrimDetailScriptTwo : MonoBehaviour
{
	...
	private void UpdateText(int index, int parentValue)
	{
		informativeText.text += $"parent[{index}] - {parentValue}\n";
	}
